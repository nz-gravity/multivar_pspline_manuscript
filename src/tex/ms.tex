...
\begin{document}
    ...
    achieves a relative mean squared (Frobenius) error (RMSE) that
    ...
    \AET\ noise covariance agree to within a few parts in $10^{3}$.
    Under realistic asymmetric per-MOSA noise the \AET-diagonal
    assumption fails by an order of magnitude in RMSE
