...
\begin{document}
    ...
    ground truth, and on simulated LISA TDI data in a symmetric and a
    physically realistic asymmetric per-MOSA noise configuration. In the
    asymmetric case an AET-restricted model fails by an order of magnitude in
    relative integrated absolute error while the full multivariate model
    ...
    closed-form ground truth is reported in Appendix~\ref{app:bivariate}.
	...
	sample sizes $n=256,512,1024$ (refer to~\citet[Section~4.2,][]{yixuan_vnpc} for the
